...
6. If matlab is already installed, the application may be run by running the "LEVIS_exported.m" script. The "input_data" folder and the two scripts "multi_cycle_func.m" and "simulation_main_func.m" must be in the same directory
